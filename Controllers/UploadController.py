    ...
    def post(self):
        try:
            ...
            if not UploadService.allowed_file(request.files["file"].filename):
                return Response(
                    "Prohibited file type", status=400
                )  # TODO: Append to response: Dynamically return the types of allowed files
            ...
            return Response(
                "Empty fields detected. Please remove empty values from your dataset and try again.",
                status=400,
            )
